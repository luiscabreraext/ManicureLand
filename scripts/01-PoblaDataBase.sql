...
INSERT INTO dbo.Dedo (extremidad,descripción) VALUES ('PI','Dedo meñique Pie IZQUIERDA');0
...
INSERT INTO dbo.Cliente (nombres,apellidoPaterno,apellidoMaterno,fechaNacimiento,correo,clave,telefono,fechaRegistro,advertencias,estado) VALUES ('Evelio','Rivas','Osorio','30/10/1996','liorivas@correo.cl','oongooVo0','+56977989084',getdate(),1,1);
INSERT INTO dbo.Cliente (nombres,apellidoPaterno,apellidoMaterno,fechaNacimiento,correo,clave,telefono,fechaRegistro,advertencias,estado) VALUES ('Kalen','Ruvalcaba','Covarrubias','22/06/1983','kalirc@correo.cl','aneeJ2aing','+56913250585',getdate(),0,1);
INSERT INTO dbo.Cliente (nombres,apellidoPaterno,apellidoMaterno,fechaNacimiento,correo,clave,telefono,fechaRegistro,advertencias,estado) VALUES ('Saidi','Barrios','Cerda','30/10/1991','saidb@correo.cl','aev1Xae4ie','+56974239952',getdate(),0,1);
INSERT INTO dbo.Cliente (nombres,apellidoPaterno,apellidoMaterno,fechaNacimiento,correo,clave,telefono,fechaRegistro,advertencias,estado) VALUES ('Preciosa','Fierro','Montez','25/02/1980','pfierrom@correo.cl','aeHodoh5e','+56914574852',getdate(),0,1);
...
INSERT INTO dbo.Cliente (nombres,apellidoPaterno,apellidoMaterno,fechaNacimiento,correo,clave,telefono,fechaRegistro,advertencias,estado) VALUES ('Brenda','Mojica','Palacios','14/08/1989','brenditadelboom@correo.cl','eeg9oy8Tahch','+56956522109',getdate(),2,1);
INSERT INTO dbo.Cliente (nombres,apellidoPaterno,apellidoMaterno,fechaNacimiento,correo,clave,telefono,fechaRegistro,advertencias,estado) VALUES ('Katriel','Rosario','Arreola','26/10/1993','katriolaross@correo.cl','Jaiqu9Ein','+56906444357',getdate(),0,1);
INSERT INTO dbo.Cliente (nombres,apellidoPaterno,apellidoMaterno,fechaNacimiento,correo,clave,telefono,fechaRegistro,advertencias,estado) VALUES ('Taiana','Cavazos','Arellano','14/09/1982','taicaArellano@correo.cl','Spee1982','+56948028052',getdate(),0,1);
INSERT INTO dbo.Cliente (nombres,apellidoPaterno,apellidoMaterno,fechaNacimiento,correo,clave,telefono,fechaRegistro,advertencias,estado) VALUES ('Cristal','Viera','Nevares','13/06/1976','cristalviernez@correo.cl','EiGegeemah8','+5693133774',getdate(),0,1);
INSERT INTO dbo.Cliente (nombres,apellidoPaterno,apellidoMaterno,fechaNacimiento,correo,clave,telefono,fechaRegistro,advertencias,estado) VALUES ('Elsira','Pichardo','Roque','27/04/1994','elsipichro@correo.cl','ohgohDee9ue','+56970288703',getdate(),0,1);
INSERT INTO dbo.Cliente (nombres,apellidoPaterno,apellidoMaterno,fechaNacimiento,correo,clave,telefono,fechaRegistro,advertencias,estado) VALUES ('Lidia Alva','Salcido','Guzman','22/01/1997','lidiasal@correo.cl','Ooz2woo5','+56958709003',getdate(),3,0);
INSERT INTO dbo.Cliente (nombres,apellidoPaterno,apellidoMaterno,fechaNacimiento,correo,clave,telefono,fechaRegistro,advertencias,estado) VALUES ('Larry Taciano','Zavala','Duran','22/01/1997','lidiasal@correo.cl','Ooz2woo5','+56958709003',getdate(),3,0);
